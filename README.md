...
Inclui algumas operações matemáticas, sendo estas adição, subtração, multiplicação, divisão, potenciação e fatorial.

Para compilar e executar o programa:

1. Utilizando o terminal, digite 'make' para compilar os códigos.
